...
@Component({
  selector: 'app-dialog-add-fixcosts',
  templateUrl: './dialog-add-fixcosts.component.html',
  styleUrls: ['./dialog-add-fixcosts.component.scss']
})
export class DialogAddFixcostsComponent {
